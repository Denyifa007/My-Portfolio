  ...
  return (
    <div name='home' className=' w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 pt-20 flex flex-col justify-center h-full'>
            <p className='text-[#E31B6D]'>Hi, my name is</p>
            <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Oyeindenyifa Samuel Diegbegha</h1>
            ...
            <div>
                <button className='text-white group border-2 px-6 py-3 my-2 flex rounded-md bg-gradient-to-r from-pink-400 to-pink-600 items-center hover:bg-pink-600 hover:border-pink-600 '>
                    View Work
